...
BEGIN
  ...
  INSERT INTO auth.identities (id,user_id,identity_data,provider,provider_id,last_sign_in_at,created_at,updated_at) VALUES
    (gen_random_uuid(),s01,jsonb_build_object('sub',s01::text,'email','24cy101@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s01::text,'2024-06-10 08:00:00+00','2024-06-10 08:00:00+00','2024-06-10 08:00:00+00'),
    (gen_random_uuid(),s02,jsonb_build_object('sub',s02::text,'email','24cy102@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s02::text,'2024-06-10 08:05:00+00','2024-06-10 08:05:00+00','2024-06-10 08:05:00+00'),
    (gen_random_uuid(),s03,jsonb_build_object('sub',s03::text,'email','24cy103@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s03::text,'2024-06-10 08:10:00+00','2024-06-10 08:10:00+00','2024-06-10 08:10:00+00'),
    (gen_random_uuid(),s04,jsonb_build_object('sub',s04::text,'email','24cy104@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s04::text,'2024-06-10 08:15:00+00','2024-06-10 08:15:00+00','2024-06-10 08:15:00+00'),
    (gen_random_uuid(),s05,jsonb_build_object('sub',s05::text,'email','24cy105@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s05::text,'2024-06-10 08:20:00+00','2024-06-10 08:20:00+00','2024-06-10 08:20:00+00'),
    (gen_random_uuid(),s06,jsonb_build_object('sub',s06::text,'email','24cy106@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s06::text,'2024-06-10 08:25:00+00','2024-06-10 08:25:00+00','2024-06-10 08:25:00+00'),
    (gen_random_uuid(),s07,jsonb_build_object('sub',s07::text,'email','24cy107@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s07::text,'2024-06-10 08:30:00+00','2024-06-10 08:30:00+00','2024-06-10 08:30:00+00'),
    (gen_random_uuid(),s08,jsonb_build_object('sub',s08::text,'email','24cy108@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s08::text,'2024-06-10 08:35:00+00','2024-06-10 08:35:00+00','2024-06-10 08:35:00+00'),
    (gen_random_uuid(),s09,jsonb_build_object('sub',s09::text,'email','24cy109@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s09::text,'2024-06-10 08:40:00+00','2024-06-10 08:40:00+00','2024-06-10 08:40:00+00'),
    (gen_random_uuid(),s10,jsonb_build_object('sub',s10::text,'email','24cy110@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s10::text,'2024-06-10 08:45:00+00','2024-06-10 08:45:00+00','2024-06-10 08:45:00+00'),
    (gen_random_uuid(),s11,jsonb_build_object('sub',s11::text,'email','24cy111@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s11::text,'2024-06-10 08:50:00+00','2024-06-10 08:50:00+00','2024-06-10 08:50:00+00'),
    (gen_random_uuid(),s12,jsonb_build_object('sub',s12::text,'email','24cy112@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s12::text,'2024-06-10 08:55:00+00','2024-06-10 08:55:00+00','2024-06-10 08:55:00+00'),
    (gen_random_uuid(),s13,jsonb_build_object('sub',s13::text,'email','24cy113@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s13::text,'2024-06-10 09:00:00+00','2024-06-10 09:00:00+00','2024-06-10 09:00:00+00'),
    (gen_random_uuid(),s14,jsonb_build_object('sub',s14::text,'email','24cy114@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s14::text,'2024-06-10 09:05:00+00','2024-06-10 09:05:00+00','2024-06-10 09:05:00+00'),
    (gen_random_uuid(),s15,jsonb_build_object('sub',s15::text,'email','24cy115@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s15::text,'2024-06-10 09:10:00+00','2024-06-10 09:10:00+00','2024-06-10 09:10:00+00'),
    (gen_random_uuid(),s16,jsonb_build_object('sub',s16::text,'email','24cy116@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s16::text,'2024-06-10 09:15:00+00','2024-06-10 09:15:00+00','2024-06-10 09:15:00+00'),
    (gen_random_uuid(),s17,jsonb_build_object('sub',s17::text,'email','24cy117@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s17::text,'2024-06-10 09:20:00+00','2024-06-10 09:20:00+00','2024-06-10 09:20:00+00'),
    (gen_random_uuid(),s18,jsonb_build_object('sub',s18::text,'email','24cy118@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s18::text,'2024-06-10 09:25:00+00','2024-06-10 09:25:00+00','2024-06-10 09:25:00+00'),
    (gen_random_uuid(),s19,jsonb_build_object('sub',s19::text,'email','24cy119@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s19::text,'2024-06-10 09:30:00+00','2024-06-10 09:30:00+00','2024-06-10 09:30:00+00'),
    (gen_random_uuid(),s20,jsonb_build_object('sub',s20::text,'email','24cy120@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s20::text,'2024-06-10 09:35:00+00','2024-06-10 09:35:00+00','2024-06-10 09:35:00+00'),
    (gen_random_uuid(),s21,jsonb_build_object('sub',s21::text,'email','23cs201@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s21::text,'2023-06-12 08:00:00+00','2023-06-12 08:00:00+00','2023-06-12 08:00:00+00'),
    (gen_random_uuid(),s22,jsonb_build_object('sub',s22::text,'email','23cs202@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s22::text,'2023-06-12 08:10:00+00','2023-06-12 08:10:00+00','2023-06-12 08:10:00+00'),
    (gen_random_uuid(),s23,jsonb_build_object('sub',s23::text,'email','23cs203@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s23::text,'2023-06-12 08:20:00+00','2023-06-12 08:20:00+00','2023-06-12 08:20:00+00'),
    (gen_random_uuid(),s24,jsonb_build_object('sub',s24::text,'email','23cs204@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s24::text,'2023-06-12 08:30:00+00','2023-06-12 08:30:00+00','2023-06-12 08:30:00+00'),
    (gen_random_uuid(),s25,jsonb_build_object('sub',s25::text,'email','23cs205@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s25::text,'2023-06-12 08:40:00+00','2023-06-12 08:40:00+00','2023-06-12 08:40:00+00'),
    (gen_random_uuid(),s26,jsonb_build_object('sub',s26::text,'email','23cs206@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s26::text,'2023-06-12 08:50:00+00','2023-06-12 08:50:00+00','2023-06-12 08:50:00+00'),
    (gen_random_uuid(),s27,jsonb_build_object('sub',s27::text,'email','23cs207@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s27::text,'2023-06-12 09:00:00+00','2023-06-12 09:00:00+00','2023-06-12 09:00:00+00'),
    (gen_random_uuid(),s28,jsonb_build_object('sub',s28::text,'email','23cs208@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s28::text,'2023-06-12 09:10:00+00','2023-06-12 09:10:00+00','2023-06-12 09:10:00+00'),
    (gen_random_uuid(),s29,jsonb_build_object('sub',s29::text,'email','23cs209@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s29::text,'2023-06-12 09:20:00+00','2023-06-12 09:20:00+00','2023-06-12 09:20:00+00'),
    (gen_random_uuid(),s30,jsonb_build_object('sub',s30::text,'email','23cs210@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s30::text,'2023-06-12 09:30:00+00','2023-06-12 09:30:00+00','2023-06-12 09:30:00+00'),
    (gen_random_uuid(),s31,jsonb_build_object('sub',s31::text,'email','22ec301@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s31::text,'2022-06-15 08:00:00+00','2022-06-15 08:00:00+00','2022-06-15 08:00:00+00'),
    (gen_random_uuid(),s32,jsonb_build_object('sub',s32::text,'email','22ec302@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s32::text,'2022-06-15 08:10:00+00','2022-06-15 08:10:00+00','2022-06-15 08:10:00+00'),
    (gen_random_uuid(),s33,jsonb_build_object('sub',s33::text,'email','22ec303@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s33::text,'2022-06-15 08:20:00+00','2022-06-15 08:20:00+00','2022-06-15 08:20:00+00'),
    (gen_random_uuid(),s34,jsonb_build_object('sub',s34::text,'email','22ec304@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s34::text,'2022-06-15 08:30:00+00','2022-06-15 08:30:00+00','2022-06-15 08:30:00+00'),
    (gen_random_uuid(),s35,jsonb_build_object('sub',s35::text,'email','22ec305@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s35::text,'2022-06-15 08:40:00+00','2022-06-15 08:40:00+00','2022-06-15 08:40:00+00'),
    (gen_random_uuid(),s36,jsonb_build_object('sub',s36::text,'email','22ec306@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s36::text,'2022-06-15 08:50:00+00','2022-06-15 08:50:00+00','2022-06-15 08:50:00+00'),
    (gen_random_uuid(),s37,jsonb_build_object('sub',s37::text,'email','22ec307@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s37::text,'2022-06-15 09:00:00+00','2022-06-15 09:00:00+00','2022-06-15 09:00:00+00'),
    (gen_random_uuid(),s38,jsonb_build_object('sub',s38::text,'email','22ec308@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s38::text,'2022-06-15 09:10:00+00','2022-06-15 09:10:00+00','2022-06-15 09:10:00+00'),
    (gen_random_uuid(),s39,jsonb_build_object('sub',s39::text,'email','22ec309@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s39::text,'2022-06-15 09:20:00+00','2022-06-15 09:20:00+00','2022-06-15 09:20:00+00'),
    (gen_random_uuid(),s40,jsonb_build_object('sub',s40::text,'email','22ec310@mgits.ac.in','email_verified',true,'phone_verified',false),'email',s40::text,'2022-06-15 09:30:00+00','2022-06-15 09:30:00+00','2022-06-15 09:30:00+00')
  ...
  -- ================================================================
  INSERT INTO auth.identities (id,user_id,identity_data,provider,provider_id,last_sign_in_at,created_at,updated_at) VALUES
    (gen_random_uuid(),f01,jsonb_build_object('sub',f01::text,'email','rajesh.kumar@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f01::text,'2021-07-01 09:00:00+00','2021-07-01 09:00:00+00','2021-07-01 09:00:00+00'),
    (gen_random_uuid(),f02,jsonb_build_object('sub',f02::text,'email','meena.babu@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f02::text,'2021-07-01 09:10:00+00','2021-07-01 09:10:00+00','2021-07-01 09:10:00+00'),
    (gen_random_uuid(),f03,jsonb_build_object('sub',f03::text,'email','suresh.nair@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f03::text,'2021-07-01 09:20:00+00','2021-07-01 09:20:00+00','2021-07-01 09:20:00+00'),
    (gen_random_uuid(),f04,jsonb_build_object('sub',f04::text,'email','latha.krishnan@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f04::text,'2021-07-01 09:30:00+00','2021-07-01 09:30:00+00','2021-07-01 09:30:00+00'),
    (gen_random_uuid(),f05,jsonb_build_object('sub',f05::text,'email','anil.varghese@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f05::text,'2021-07-01 09:40:00+00','2021-07-01 09:40:00+00','2021-07-01 09:40:00+00'),
    (gen_random_uuid(),f06,jsonb_build_object('sub',f06::text,'email','bindu.thomas@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f06::text,'2026-01-10 10:00:00+00','2026-01-10 10:00:00+00','2026-01-10 10:00:00+00'),
    (gen_random_uuid(),f07,jsonb_build_object('sub',f07::text,'email','ravi.prakash@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f07::text,'2026-01-12 10:00:00+00','2026-01-12 10:00:00+00','2026-01-12 10:00:00+00'),
    (gen_random_uuid(),f08,jsonb_build_object('sub',f08::text,'email','seema.nambiar@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f08::text,'2026-01-15 10:00:00+00','2026-01-15 10:00:00+00','2026-01-15 10:00:00+00'),
    (gen_random_uuid(),f09,jsonb_build_object('sub',f09::text,'email','jijo.abraham@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f09::text,'2026-02-01 10:00:00+00','2026-02-01 10:00:00+00','2026-02-01 10:00:00+00'),
    (gen_random_uuid(),f10,jsonb_build_object('sub',f10::text,'email','anju.sreedharan@mgits.ac.in','email_verified',true,'phone_verified',false),'email',f10::text,'2026-02-05 10:00:00+00','2026-02-05 10:00:00+00','2026-02-05 10:00:00+00')
  ON CONFLICT (provider,provider_id) DO NOTHING;
